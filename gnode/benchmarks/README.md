...
- `runtime-shootout.mjs` benchmarks the same small TS entrypoints across `gnode`, Bun, `tsx`, `ts-node`, plain Node on ahead-of-time compiled JavaScript, and Deno when it is installed.
