...
describe('GnosisNeo4jBridge', () => {
    ...
    it('should translate GGL edges to Cypher MERGE statements', () => {
        ...
        expect(cypher).toContain("MATCH (s:GnosisNode {id: 'a'}), (t:GnosisNode {id: 'b'}) MERGE (s)-[r:FORK { edgeIndex: 0 }]->(t)");
        expect(cypher).toContain("MATCH (s:GnosisNode {id: 'a'}), (t:GnosisNode {id: 'c'}) MERGE (s)-[r:FORK { edgeIndex: 0 }]->(t)");
    });

    it('should respect custom options', () => {
        const ggl = '(a)';
        const cypher = bridge.gglToCypher(ggl, { nodeLabel: 'Neuron', idPrefix: 'l1_' });
