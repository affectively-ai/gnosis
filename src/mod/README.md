...
- [loader.ts](./loader.ts): native `.mgg` import/export parsing, filesystem-backed and lockfile-backed module resolution, cycle detection, AST merge/lowering, and canonical merged-source rendering for CLI/runtime consumers.
