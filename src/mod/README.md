...
- [loader.gg](./loader.gg): GG-native module loading pipeline (`parse -> resolve-specifiers -> load-imports -> validate-imports -> compile -> determine-exports -> merge -> validate-exports -> assemble`) used by the host shim for `.mgg` orchestration.
